...
public class IsValidRectangularPrismTest {
    ...
    public void testIsValidRectangularPrismWithValidInputs() {
        ...
        double width = 10.0;
        double height = 8.0;
        assertTrue(RoomPaintingCostCalculator.isValidRectangularPrism(length, width, height),
    ...
    public void testIsValidRectangularPrismWithBoundaryInputs() {
        ...
        assertTrue(RoomPaintingCostCalculator.isValidRectangularPrism(0.0001, 0.0001, 0.0001),
