 ...
 * 
 * The chatbot continuously prompts the user for input until they type "bye" or
 * "exit". It analyzes the user's message using a set of keyword-based rules to
 * generate responses:
 * 
 * Rules:
...
public class CustomerServiceChatBotSolution {
