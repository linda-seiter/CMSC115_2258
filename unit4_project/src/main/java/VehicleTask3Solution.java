 ...
 * SUV: Perfect for off-road trips.
 */
public class VehicleTask3Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the vehicle type (Sedan, SUV, Truck): ");
        String vehicleType = scanner.next();

        // Use switch expression to assign message variable based on vehicle type
        String message = switch (vehicleType) {
            case "Sedan" -> "Sedan: Great for commuting.";
            case "SUV" -> "SUV: Perfect for off-road trips.";
            case "Truck" -> "Truck: Great for heavy loads.";
            default -> "Uncommon: " + vehicleType;
        };
