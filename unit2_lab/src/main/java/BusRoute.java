/**
 * BusRoute class demonstrates augmented assignment operators and increment
 * operator.
 * 
 * @author First Last
 */
public class BusRoute {
	...
	public static void main(String[] args) {
		...
		// TODO: next stop, half the passengers get off (use division assignment
		// operator)

		// TODO: next stop, the number of passengers triples (use multiplication
		// assignment operator)
