...
public class BasketballGame {
	...
	public static void main(String[] args) {
		...
		// TODO: Home team doubles their score from the 1st quarter using the
		// multiplication assignment operator

		// TODO: Away team ties the game by matching the home team's score

		// Print the updated scores for the 2nd quarter
		System.out.println("2nd quarter scores: home " + homeScore + " away " + awayScore);

		// TODO: Away team challenges the home team's last play. The home team's score
		...
		// TODO: Home team increases their score by 10 points using the addition
		// assignment operator.

		// TODO: Away team leads by 5 points, so their score is set to be 5 points ahead
		// of the home team's score.

		// Print the updated scores for the 3rd quarter
		System.out.println("3rd quarter scores: home " + homeScore + " away " + awayScore);

		// TODO: Home team receives a free throw from a challenge, increasing their
		// score by 1 using the increment operator.
